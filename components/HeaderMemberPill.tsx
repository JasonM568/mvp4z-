...
// SiteHeader 右側的會員態 pill：未登入顯示「會員登入」，已登入讀 localStorage token + /api/member/me 切到「會員中心 | PLAN | 剩 N 點」。
// 為避免 hydration mismatch，初始 render 永遠是「會員登入」，client mount 後才換成會員樣式。
