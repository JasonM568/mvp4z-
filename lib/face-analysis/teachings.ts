...
export type Teaching = Readonly<{
  ...
  /** 教材說法，可直接進會員報告。 */
  memberText: string;
  /** 老師原文摘要；healthSensitive 為 true 時只給老師版。 */
  teacherText: string;
...
export const BUILT_IN_TEACHINGS: readonly Teaching[] = [
  // ── 額頭（官祿宮／父母宮／遷移宮／天倉）────────────────────────────
  {
    ...
    memberText:
      "老師以額頭高、寬、髮際平整為好額的條件，對應年少階段的資源與思考的施展空間，也代表較知道長輩要什麼、與長上相處的方式較順。",
  ...
  },
  {
    ...
    memberText:
      "老師說額頭寬廣對應年輕階段的發展空間，臨機應變與多變的處理能力較能施展；遷移宮的山林驛馬也在這一帶，與外出、變動的空間有關。",
  ...
  },
  {
    ...
    memberText:
      "老師以額頭低窄為面積不足，對應年少階段較奔波、可運用的資源較有限；遷移宮這一段窄，也對應年輕時發展空間較受限、較容易有志難伸的處境。老師同時指出若骨相好仍可翻身。",
  ...
  },
  {
    ...
    memberText:
      "老師說額頭偏低這一段，對應的是規劃與判斷要更靠實作累積，賺錢的路徑通常不是靠一次想清楚，而是靠反覆試。建議把重大判斷拆小、留紀錄再回看。",
  ...
  },
  {
    ...
    memberText:
      "老師說額頭一高一低，對應年輕階段的起伏會比較明顯，好一年、不好一年交替。父母宮的日月角也在這一帶，左右差異在老師裡對應與雙親兩邊的緣分深淺不同。",
  ...
  // ── 印堂（命宮）────────────────────────────────────────────────
  {
    ...
    when: { relativeWidth: ["wide"] },
    memberText:
      "老師以印堂開闊平整、可容兩指幅為標準相理，對應心胸與包容的空間較大，遇事的迴旋餘地較足。印堂是命宮，也是當陽十三部位的正中央。",
  ...
  },
  {
    ...
    when: { relativeWidth: ["narrow"] },
    memberText:
      "老師說印堂不開、兩眉逼近這一段，對應遇事容易鑽牛角尖、迴旋空間較小。建議在做重大決定前刻意多留一段緩衝時間，並找一個固定的人對話。",
  ...
  // ── 眉（兄弟宮／福德宮）─────────────────────────────────────────
  {
    ...
    memberText:
      "老師以眉形秀麗、眉頭不亂、眉尾聚而不散為好眉的條件，對應手足與同輩之間的相處較順，情緒的穩定度也較夠。眉屬兄弟宮。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說眉毛一高一低，對應手足或同輩之間的親疏不均，也常反映在情緒起伏上。眉這一段對應流年 31 至 34 歲，可回看那幾年的人際變化。",
  ...
  },
  {
    ...
    when: { relativeHeight: ["short"] },
    memberText:
      "老師說眉薄眉疏這一段，對應與人建立深交的速度較慢，也提到眉無形則不聚財、眉尾散對應存不住錢。建議把儲蓄改成自動化，不靠當下決定。",
  ...
  // ── 眼（田宅宮／夫妻宮輔）───────────────────────────────────────
  {
    ...
    memberText:
      "老師以眼形細長、眼神收斂為佳，對應看事情的耐性與收放較穩，不容易被當下情緒帶走。眼瞼屬田宅宮，也是夫妻宮的輔看部位。",
  ...
  },
  {
    ...
    memberText:
      "老師說眼睛短圓這一段，對應情緒的反應比較快、也比較外顯。建議在會被情緒牽動的場合（談錢、談合約、談關係）刻意延後一天再回覆。眼部對應流年 35 至 40 歲。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說眼睛一大一小這一段，對應對人的判斷容易兩極、親疏落差大。眼部流年 37、38 歲在老師裡常用來對照感情與財務上的變動，可以拿那兩年的實際紀錄回看。",
  ...
  // ── 山根（疾厄宮）──────────────────────────────────────────────
  {
    ...
    when: { relativeWidth: ["wide"], relativeHeight: ["long"] },
    memberText:
      "山根是疾厄宮的主看部位，老師以高、寬、厚、清楚為標準相理。這一段同時是四隘中的 41 歲關卡，建議把它當成定期健檢與作息紀錄的提醒點，不作任何身體狀況的判斷。",
  ...
  },
  {
    ...
    when: { relativeHeight: ["short"] },
    memberText:
      "老師說山根低陷這一段，對應自信心在關鍵時刻比較容易動搖，物質層面的累積也較費力。山根對應流年 41 歲，是老師四隘之一，建議在該年前後把健檢與工作安排都排進行事曆。",
  ...
  // ── 鼻（財帛宮人倉）────────────────────────────────────────────
  {
    ...
    when: { relativeWidth: ["wide"], relativeHeight: ["medium", "long"] },
    memberText:
      "鼻是財帛宮的人倉，對應 31 至 50 歲自賺之財。老師以鼻樑要挺、鼻要大、兩翼蘭台廷尉對稱為標準相理，這一段對應自我主張與掌握資源的力道。",
  ...
  },
  {
    ...
    when: { relativeHeight: ["short"] },
    memberText:
      "老師說鼻偏低這一段，對應自己作主的力道要靠制度補，不容易只憑個人堅持推動事情。鼻部對應流年 41 至 50 歲，建議在這段年紀把重要合作寫成書面條件。",
  ...
  },
  {
    ...
    memberText:
      "老師說鼻樑骨偏尖削、骨多於肉這一段，對應人際上的迴旋較少，事情容易自己扛。建議刻意保留一到兩個可以講真話的對象，並在 41 歲前後檢視伴侶與合作關係的實際狀態。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說鼻兩翼不對稱這一段，對應好勝心與冒險傾向較強。建議把賭性會被放大的場合先設上限（金額、時間、次數），對應流年在 44 至 50 歲。",
  ...
  // ── 顴（兄弟宮輔／權柄）─────────────────────────────────────────
  {
    ...
    memberText:
      "老師以顴骨隱圓為最好的相理，像雞蛋藏著，笑的時候會有兩塊，對應企圖心、外交手腕與決斷力三者較均衡。顴對應流年 46、47 歲。",
  ...
  },
  {
    ...
    when: { relativeWidth: ["wide"] },
    memberText:
      "老師說顴骨橫張對應企圖心旺、朋友群多、外交手腕佳，但關係也會比較複雜，各種層次的人都可能成為朋友。建議把合作對象分層管理，不要一視同仁。",
  ...
  },
  {
    ...
    when: { relativeWidth: ["narrow"] },
    memberText:
      "老師說顴骨塌陷對應交友圈較窄、比較顧自己，協調與靈活度要刻意補。顴是輔佐的部位，老師強調主要仍看鼻。建議在需要授權的場合明確寫下分工。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說顴骨不對稱這一段，對應 44 至 50 歲之間的起伏會比較大，大好大壞交替。老師也提到 46、47 歲這兩年在合夥投資上要特別謹慎。",
  ...
  // ── 人中（子女宮輔）────────────────────────────────────────────
  {
    ...
    memberText:
      "老師以人中寬、深、長、正為標準相理，對應包容力大、能付出與照顧的時間比較長。人中對應流年 51 歲，是老師四隘之一。健康面只建議以實際健檢核對。",
  ...
  },
  {
    ...
    when: { relativeHeight: ["short"] },
    memberText:
      "老師說人中偏淺、偏短這一段，對應在合夥與投資上要更保守，也提醒把與晚輩的溝通方式放慢。人中對應流年 51 歲，老師建議用這一年前後的實際紀錄回看。",
  ...
  // ── 口（水星）─────────────────────────────────────────────────
  {
    ...
    when: { relativeWidth: ["wide"] },
    memberText:
      "老師把嘴視為出納官與水星，看表達、飲食、賺錢能力與意志力。口大這一段對應表達與爭取的力道較強，對應流年 56 至 64 歲的嘴局。",
  ...
  },
  {
    ...
    when: { relativeWidth: ["narrow"] },
    memberText:
      "老師說嘴偏小、偏鬆這一段，若同時下巴偏尖，對應在託付與授權上要更小心，把交辦的事寫清楚驗收條件。對應流年在 56 至 64 歲。",
  ...
  // ── 地閣／下顎（財帛宮地倉／奴僕宮）──────────────────────────────
  {
    ...
    when: { relativeWidth: ["wide"] },
    memberText:
      "老師以地閣開闊飽滿、骨要多於肉、地閣微朝為標準相理，對應包容力大、晚年的資源與居所較穩，與子女晚輩的關係也較開。地閣是財帛宮的地倉，對應流年 71 歲。",
  ...
  },
  {
    ...
    when: { relativeWidth: ["narrow"] },
    memberText:
      "老師說地閣骨內縮、下巴尖削狹窄這一段，對應晚年要更早自己安排，與子女晚輩容易有距離或代溝，個性上也偏固執。老師同時說地閣骨內收但微朝者，財務的支配力仍在。",
  ...
  },
  {
    ...
    when: { contour: ["angular"] },
    memberText:
      "老師說下巴尖削這一段，對應與周邊鄰里、同住者的摩擦要多留意，處理方式建議走書面與明確界線。對應流年 61 歲承漿與 71 歲地閣兩個關卡。",
  ...
  },
  {
    ...
    when: { relativeWidth: ["wide"] },
    memberText:
      "下顎腮骨是奴僕宮的主看部位，老師以骨相開闊為部屬與晚輩的承載條件。這一段對應流年 58 歲之後的下停區段，與團隊、託付安排有關。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說地閣骨左右不齊（違章建築）這一段，對應與子女、部屬容易有意見不合與代溝。建議把長期的交辦與家庭安排改成定期對齊，不靠臨時溝通。",
  ...
  // ── 耳（幼年段）────────────────────────────────────────────────
  {
    ...
    memberText:
      "老師以耳正（子午垂直）、耳貼、城廓分明為標準相理，對應聽得進意見、思維較正向。耳對應流年 1 至 14 歲的幼年段，通常回看成長環境，不作為當前結論。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說耳形左右差異明顯這一段，對應幼年階段兩邊家庭資源的落差。老師也提到反耳骨對應較不受教、容易產生盲點，建議在重大決定前刻意找反對意見。",
  ...
  // ── 奸門（夫妻宮）／淚堂（子女宮）────────────────────────────────
  {
    ...
    memberText:
      "奸門是夫妻宮的主看部位，老師以豐盈平整為傳統正向條件，但強調不能單看奸門，必須同時交叉眉、眼、鼻、印堂這個十字帶，也不能由一張照片斷定婚姻結果。",
  ...
  },
  {
    ...
    when: { symmetry: ["asymmetric"] },
    memberText:
      "老師說奸門左右不齊這一段，作為「感情上的相處節奏兩邊不一致」的提醒，建議用實際的溝通紀錄核對，不能由此判定關係好壞。夫妻宮必須交叉眉、眼、鼻、印堂十字帶一起看。",
  ...
  },
  {
    ...
    memberText:
      "淚堂是子女宮的主看部位，老師把這一區視為與子女、晚輩相處的觀察點，飽滿平整對應能付出的心力較足。老師要求交叉人中與地閣一起看，不由單一部位推定子女的命運。",
