...
export const BUILT_IN_FINGERPRINTS: Readonly<Record<FingerprintFeature, FingerprintMapping>> = {
  foreheadShape: {
    ...
    favorable: "老師以額頭高、寬、髮際平整、沒有破相為好額；男生三至四指幅為佳。對應年少資源足、知道長上要什麼。",
  ...
  eyebrowShape: {
    ...
    favorable: "老師以眉形秀麗、眉頭不亂、眉退印（眉離眼遠、印堂寬闊）為佳；眉尾聚者功名光彩。",
    unfavorable: "眉毛稀疏不好相處；眉散則情緒不穩；兩眉交鎖、雜紋多在老師屬不利的相理。",
  ...
  eyebrowTail: {
    ...
    palaces: ["兄弟宮", "福德宮"],
    flowYearAges: [34],
    looksAt: "聚合的能力，老師同時看錢財是否留得住與情緒收放",
    favorable: "眉尾聚而不散，老師說眉尾聚者功名光彩。",
    unfavorable: "眉尾散不聚，老師說不聚財、情緒不穩定；眉無形則不聚財。",
  ...
  eyeShape: {
    ...
    looksAt: "看事情的耐性與情緒收放",
    favorable: "老師以眼形宜正不宜偏、眼如刀裁者情緒穩定、理性為佳。",
    unfavorable: "眼睛短圓對應情緒化、眼神睜露；眼形不正在老師屬需保留的相理。",
  ...
  eyeTilt: {
    ...
    flowYearAges: [35, 36, 37, 38, 39, 40],
    looksAt: "情感相處的節奏與爭鬥性",
    favorable: "老師說眼尾稍微高一點還好，收尾乾淨為佳。",
    unfavorable: "眼尾太高、吊眼梢在老師屬不佳；眼尾收尾不好、魚尾紋多對應較勞累。",
  ...
  eyeSpacing: {
    ...
    favorable: "老師以眉退印、印堂寬而清秀為佳，對應個性穩定、包容力強、心胸開闊，容兩指幅為標準。",
  ...
  nasalBridge: {
    ...
    palaces: ["疾厄宮", "財帛宮（人倉）"],
    flowYearAges: [44, 45],
    looksAt: "自己作主的力道，老師說鼻為自界、鼻正心正",
    favorable: "老師以鼻樑要挺、要大、鼻梁骨寬為佳；鼻正心正。",
    unfavorable: "鼻樑低陷則作主的力道要靠制度補；鼻梁骨特別尖削、只有骨頭沒有肉，老師說不發是肇因於自己。",
  ...
  noseTip: {
    ...
    palaces: ["財帛宮（人倉）"],
    flowYearAges: [48],
    looksAt: "財帛的核心部位，老師說鼻准是財產多少",
    favorable: "老師說鼻准豐隆、鼻准大的，理財能力與賺錢能力好；52 歲以後要聚大財，也要看鼻准氣勢。",
    unfavorable: "鼻准有尖、有骨沒有肉；朝天鼻（鼻翼清楚見到鼻孔）老師說存錢能力不足、花錢能力好，48、49、50 流年損財。",
  ...
  noseWing: {
    ...
    palaces: ["財帛宮（人倉）"],
    flowYearAges: [49, 50],
    looksAt: "守成與人際的收放，老師說蘭台廷尉主監察",
    favorable: "老師說鼻梁骨寬、兩翼開者，人際關係融合、財務狀況面面俱到。",
    unfavorable: "兩翼不開；鼻桿窄而鼻翼開且肉薄（過冬的青蛙鼻）老師說很難賺錢但是愛花錢；兩翼不對稱則好勝心強、賭性強。",
    source: "283 頁筆記 p.49–96 鼻部段"
  },
  cheekbone: {
    partName: "顴骨",
    ...
    favorable: "老師說顴骨最好的是隱圓，像雞蛋藏著，笑時會有兩塊者吉，對應企圖心、外交手腕與決斷力；顴骨要對稱。",
  ...
  lipShape: {
    ...
    palaces: ["奴僕宮"],
    flowYearAges: [60],
    looksAt: "表達、意志力與賺錢能力，老師稱嘴為出納官",
    favorable: "老師說陵線分明者條理分明、分析判斷能力好、有說服力、文化水平偏高。",
  ...
  mouthCorner: {
    ...
    favorable: "老師以開大合小為佳，嘴角要超過黑眼球外側是標準相理，超過眼尾更大。",
    unfavorable: "嘴角往下、嘴巴偏小鬆弛短小，老師說晚年挨打；若同時地閣偏尖，在託付與授權上要更小心。",
    source: "283 頁筆記 p.49–96 嘴部段"
  },
  philtrumShape: {
    partName: "人中",
    ...
    looksAt: "包容力與晚輩關係，老師也用來看適不適合合夥投資",
    favorable: "老師以人中寬、深、長、正為標準相理，對應包容力大、能付出照顧的時間比較長。",
    unfavorable: "人中淺、有橫紋或偏斜，老師說在合夥與投資上要更保守。",
  ...
  jawline: {
    ...
    favorable: "老師說下顎開闊、腮骨微朝者晚年愉快，會有自己的班底，對部屬的提拔不遺餘力。",
    unfavorable: "見不到腮骨的角，老師說底下的班底會批鬥、會有派系問題；下顎尖削則承載較弱；腮骨寬者對部屬要求嚴格，賞罰兩極。",
  ...
  chinShape: {
    ...
    favorable: "老師以地閣開闊、飽滿、骨朝為標準相理，骨要多於肉；地閣微朝對應晚年財運好、子女有出息、包容力大。",
  ...
  earShape: {
    ...
    favorable: "老師以耳正（子午垂直）、耳貼、耳厚、耳長、耳大、城廓分明為標準相理；耳正者聽得進意見、思維正向，大老闆耳正貼者多。",
    unfavorable: "反耳骨者老師說個性叛逆、不受教、容易產生盲點。",
    source: "283 頁筆記 p.13"
  }
};
...
function describeAges(ages: readonly number[]): string {
  if (ages.length === 0) return "老師未對此部位標定流年歲數";
