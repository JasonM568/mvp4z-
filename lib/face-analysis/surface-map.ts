...
const SURFACE_MAPPINGS: Readonly<Record<SurfaceRegion, SurfaceMapping>> = {
  forehead: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "額頭屬官祿宮與父母宮，也是財帛宮的天倉（青年財、祖蔭）。教材認為當陽十三部位在額頭這一段有破損時，會連帶影響與長輩、上司的相處，年少階段也較奔波。",
    teacherNote:
  ...
  glabella: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "印堂是命宮，位於當陽十三部位正中央。教材說印堂有痣要留意人際上的小人干擾與較大的錢財損失，並建議用九值流年法與七十五部位流年法交互印證再下判斷。",
    teacherNote:
  ...
  eyebrows: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "眉屬兄弟宮。教材認為眉毛有傷痕與手足失和有關，眉毛有痣則常對應兄弟之間金錢借貸傷及情感，對應流年約在 31 至 34 歲這一段。",
    teacherNote:
  ...
  eyes: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "眼與眼瞼屬田宅宮，也是夫妻宮的輔看部位。教材提到眼部這一段對應流年 35 至 40 歲，其中 37、38 歲常用來對照感情與財務上的變動。",
  ...
  outerEyeCorners: {
    ...
    themes: ["六親"],
    memberNote:
      "眼尾奸門是夫妻宮的主看部位。教材以奸門豐盈平整為傳統正向條件，此處有痕跡時建議把它當成「多留意伴侶溝通」的提醒，不能單憑一張照片論斷婚姻結果。",
  ...
  tearTroughs: {
    ...
    themes: ["六親"],
    memberNote:
      "淚堂是子女宮的主看部位。教材把這一區視為與晚輩、子女相處的觀察點，有斑痕時作為關係上的提醒，不推定子女的命運。",
  ...
  nasalRoot: {
    ...
    themes: ["健康", "六親"],
    memberNote:
      "山根是疾厄宮的主看部位，也是四隘中的 41 歲關卡。教材把這一段列為健康與事業的關卡年，建議以實際健檢與作息紀錄核對，本報告不對疾病或器官下任何判斷。",
    teacherNote:
  ...
  nose: {
    ...
    themes: ["財運", "健康"],
    memberNote:
      "鼻屬財帛宮的人倉（31 至 50 歲自賺之財）。教材說鼻樑有痣對應流年 44 至 47 容易有金錢損耗，鼻準有痣則對應流年 48。這一段同時也是疾厄宮的交叉部位，健康面只建議以健檢核對。",
    teacherNote:
  ...
  cheeks: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "顴骨對應流年 46、47 歲，教材把顴視為權責與人際支持的觀察部位，也是兄弟宮的輔看處。此處有痕跡時，建議留意需要授權或協作的場合。",
  ...
  philtrum: {
    ...
    themes: ["六親", "財運", "健康"],
    memberNote:
      "人中對應流年 51 歲，是四隘之一；兩側仙庫對應 52 至 55 歲。教材把人中視為與晚輩關係、以及是否適合合夥投資的參考部位。健康面只建議以實際健檢核對。",
    teacherNote:
  ...
  mouth: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "口與周邊的食倉、祿倉、法令對應流年 54 至 60 歲，教材把這一段視為口德、飲食與部屬關係的觀察區，也與晚年的資源守成有關。",
  ...
  jaw: {
    ...
    themes: ["六親", "財運"],
    memberNote:
      "下顎腮骨是奴僕宮的主看部位，對應流年 58 歲之後的下停區段。教材把這一區視為部屬、晚輩與晚年資源的觀察處，有痕跡時作為團隊與託付安排上的提醒。",
  ...
  chin: {
    ...
    themes: ["財運", "六親", "健康"],
    memberNote:
      "地閣屬財帛宮的地倉（晚年財、子女晚輩），對應流年 61 歲承漿與 71 歲地閣兩個四隘關卡。教材說下巴這一區同時看晚年資源、子女成就與生活困擾。健康面只建議以健檢與作息紀錄核對。",
    teacherNote:
  ...
  ears: {
    ...
    themes: ["六親", "健康"],
    memberNote:
      "耳對應流年 1 至 14 歲的幼年段，教材以耳看幼年環境與家庭照顧狀況。此處的痕跡通常回看成長背景，不作為當前結論。健康面只建議以健檢核對。",
...
export type SurfaceImpact = Readonly<{
  ...
  /** 進會員報告的民俗說法。 */
  memberNote: string;
  /** 教材原文摘要，只給老師版；`generateFaceReport` 不得傳給模型。 */
  teacherNote: string;
  /** 該部位在七十五部位流年法的歲數區段。 */
